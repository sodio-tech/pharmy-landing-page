  ...
  return (
    <section className="py-20 md:py-28 bg-linear-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        ...
        <motion.div
          className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-7xl mx-auto items-start"
          ...
          {contactOptions.map((option) => (
            ...
            >
              <Card
                className={`p-8 transition-all duration-300 ${
                  option.featured
                    ...
                    : "bg-white border border-gray-200 hover:border-[#0f766e]/30 hover:shadow-xl shadow-lg"
                } rounded-2xl`}
              >
                {/* Icon */}
              ...
              <a
                ...
                className={`flex items-center justify-center gap-2 text-sm font-semibold transition-all group cursor-pointer ${
