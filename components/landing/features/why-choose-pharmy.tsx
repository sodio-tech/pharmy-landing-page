  ...
  const features = [
    {
      ...
      description: "Single platform for all pharmacy operations, eliminating the need for multiple systems.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Intelligent automation and predictive analytics to optimize your operations.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Perfect for single stores and large franchise operations with flexible scaling.",
    },
    {
      icon: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: "Enterprise-grade security with full regulatory compliance and audit trails.",
    },
  ]
